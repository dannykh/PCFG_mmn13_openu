...
from src.evalb.parser import ParsingError
from src.evalb.summary import Result
from src.evalb import parser
from src.evalb import summary
...
class Scorer:
    ...
    def evalb(self, gold_path, test_path):
        try:
            with open(gold_path, encoding='utf8') as gold_f:
                with open(test_path, encoding='utf8') as test_f:
                    ...
                    return summary.write_table(results, s)
        except:
            return "\n\nno result"